...
#      file = "D:/Documents/Proj_Damage_Spatial_Corr/Data/demo_al_sim.RData")
load(file = "D:/Documents/Proj_Damage_Spatial_Corr/Data/demo_al_sim.RData")
```

This operation takes about 15 minutes. As a check, we compute the average annual loss and associated standard deviation for each model. The results for building category 1 and 2 are given in Table 1 and 2 respectively.
